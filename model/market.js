...
class Market extends Events {
    ...
    get nextStartOfDay() {
        return this.next.start.find(start => start.isFuture());
    }
    
    get nextOpen() {
        return this.next.open.find(open => open.isFuture());
    }
    
    get nextClose() {
        return this.next.close.find(close => close.isFuture());
    }
    
    get nextEndOfDay() {
        return this.next.end.find(end => end.isFuture());
    }
