...
class Order extends Subscription {
    ...
    toString() {
        let str = `${this.ticket.action} ${this.ticket.totalQuantity} ${this.contract.summary.localSymbol} ${this.ticket.orderType} ${this.ticket.tif}`;
        if (this.ticket.lmtPrice) str += " " + this.ticket.lmtPrice;
        if (this.ticket.auxPrice) str += " " + this.ticket.auxPrice;
        if (this.ticket.trailStopPrice) str += " " + this.ticket.trailStopPrice;
    }
